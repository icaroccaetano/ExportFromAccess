...
class ModulacaoHistorico(db.Model):
    # Define o nome da tabela no banco de dados
    __tablename__ = 'SGDP_MODULACOES_HISTORICO'
...
# =================================================================================================================================================================
    ...
    vinculo:            Mapped["Vinculo"] = db.relationship("Vinculo", back_populates='modulacoes_historico')
    funcao:             Mapped["Funcao"] = db.relationship("Funcao", back_populates='modulacoes_historico')
    unidade:            Mapped["Unidade"] = db.relationship("Unidade", back_populates='modulacoes_historico')